  ...
  Widget _buildSignOutButton(BuildContext context) {
    return ElevatedButton(
      onPressed: () async {
        ...
        final box = HiveService.getPersonalityTestResultsBox();
        await box.clear();
        final box2 = HiveService.getUserPreferencesBox();
        await box2.clear();
        final box3 = HiveService.getSavedQuoteBox();
        await box3.clear();
        final box4 = HiveService.getChatMessagesBox();
        await box4.clear();
        final box5 = HiveService.getAlarmsBox();
        await box5.clear();
